 ...
 */
package com.accenture.aem.genai.core.models;
...
import com.accenture.aem.genai.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "acngenai/components/helloworld");
